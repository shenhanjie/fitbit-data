...
matplot(s.wk, t(func.mean(fdata(mvpa.dat.wk[row.names(mvpa.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 0]),],s.wk))$data),
         type='l', lty=1, col = "red", ylab = "MVPA (minutes)",xlab = "Weeks", main = "Total Weekly MVPA")
matlines(s.wk, t(func.mean(fdata(mvpa.dat.wk[row.names(mvpa.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 1]),],s.wk))$data),
         type='l', lty=1, col = "blue")
matlines(s.wk, t(func.mean(fdata(mvpa.dat.wk[row.names(mvpa.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 2]),],s.wk))$data),
         type='l', lty=1, col = "green")
matlines(s.wk, t(func.mean(fdata(mvpa.dat.wk[row.names(mvpa.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 3]),],s.wk))$data),
         type='l', lty=1, col = "brown")
legend("topright", 
...
matlines(s.wk, t(func.mean(fdata(steps.dat.wk[row.names(steps.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 0]),],s.wk))$data),
         type='l', lty=1, col = "red")
matlines(s.wk, t(func.mean(fdata(steps.dat.wk[row.names(steps.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 1]),],s.wk))$data),
         type='l', lty=1, col = "blue")
matlines(s.wk, t(func.mean(fdata(steps.dat.wk[row.names(steps.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 2]),],s.wk))$data),
         type='l', lty=1, col = "green")
matlines(s.wk, t(func.mean(fdata(steps.dat.wk[row.names(steps.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 3]),],s.wk))$data),
         type='l', lty=1, col = "brown")
legend("topright", 
       col = c("red","blue","green","brown"), 
       lty = 1, legend = c("Arm A","Arm B","Arm C","Arm D"),
...
matlines(s.wk, t(func.mean(fdata(distance.dat.wk[row.names(distance.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 0]),],s.wk))$data),
         type='l', lty=1, col = "red")
matlines(s.wk, t(func.mean(fdata(distance.dat.wk[row.names(distance.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 1]),],s.wk))$data),
         type='l', lty=1, col = "blue")
matlines(s.wk, t(func.mean(fdata(distance.dat.wk[row.names(distance.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 2]),],s.wk))$data),
         type='l', lty=1, col = "green")
matlines(s.wk, t(func.mean(fdata(distance.dat.wk[row.names(distance.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 3]),],s.wk))$data),
         type='l', lty=1, col = "brown")
legend("topright", 
       col = c("red","blue","green","brown"), 
       lty = 1, legend = c("Arm A","Arm B","Arm C","Arm D"),
...
matlines(s.wk, t(func.mean(fdata(intensity.dat.wk[row.names(intensity.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 0]),],s.wk))$data),
         type='l', lty=1, col = "red")
matlines(s.wk, t(func.mean(fdata(intensity.dat.wk[row.names(intensity.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 1]),],s.wk))$data),
         type='l', lty=1, col = "blue")
matlines(s.wk, t(func.mean(fdata(intensity.dat.wk[row.names(intensity.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 2]),],s.wk))$data),
         type='l', lty=1, col = "green")
matlines(s.wk, t(func.mean(fdata(intensity.dat.wk[row.names(intensity.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 3]),],s.wk))$data),
         type='l', lty=1, col = "brown")
legend("topright", 
       col = c("red","blue","green","brown"), 
       lty = 1, legend = c("Arm A","Arm B","Arm C","Arm D"),
...
matlines(s.wk, t(func.mean(fdata(mets.dat.wk[row.names(mets.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 0]),],s.wk))$data),
         type='l', lty=1, col = "red")
matlines(s.wk, t(func.mean(fdata(mets.dat.wk[row.names(mets.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 1]),],s.wk))$data),
         type='l', lty=1, col = "blue")
matlines(s.wk, t(func.mean(fdata(mets.dat.wk[row.names(mets.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 2]),],s.wk))$data),
         type='l', lty=1, col = "green")
matlines(s.wk, t(func.mean(fdata(mets.dat.wk[row.names(mets.dat.wk) %in% unique(alldat.wk$ID[alldat.wk$arm == 3]),],s.wk))$data),
         type='l', lty=1, col = "brown")
legend("topright", 
       col = c("red","blue","green","brown"), 
       lty = 1, legend = c("Arm A","Arm B","Arm C","Arm D"),
...
# Functional Response Linear Model (Daily)
daytime = 1:280
dayrng = c(1,280)
fbasis =  create.fourier.basis(dayrng,100)
harmLfd = vec2Lfd(c(0,(2*pi/280)^2,0),rangeval=dayrng)

# Create functional covariates
steps.fdPar = fdPar(fbasis,harmLfd,1e-2)
stepsSmooth = smooth.basis(daytime,t(steps.dat),steps.fdPar)
stepsfd = stepsSmooth$fd

intensity.fdPar = fdPar(fbasis,harmLfd,1e-2)
intensitySmooth = smooth.basis(daytime,t(intensity.dat),intensity.fdPar)
intensityfd = intensitySmooth$fd

mets.fdPar = fdPar(fbasis,harmLfd,1e-2)
metsSmooth = smooth.basis(daytime,t(mets.dat),mets.fdPar)
metsfd = metsSmooth$fd
...
mvpa.fdPar = fdPar(fbasis,harmLfd,1e6)
mvpaSmooth = smooth.basis(daytime,t(mvpa.dat),mvpa.fdPar)
mvpafd = mvpaSmooth$fd

bwtlist2 = list(len=4)
beta.fdPar2 = fdPar(fbasis,harmLfd,1e-5)
bwtlist2[[1]] = beta.fdPar2
bwtlist2[[2]] = beta.fdPar2 
bwtlist2[[3]] = beta.fdPar2 
bwtlist2[[4]] = beta.fdPar2 

mvpa.conc = fRegress(mvpafd,xlist,bwtlist2)

par(mfrow=c(2,2))
plot(mvpa.conc$betaestlist[[1]])
plot(mvpa.conc$betaestlist[[2]])
plot(mvpa.conc$betaestlist[[3]])
plot(mvpa.conc$betaestlist[[4]])

yhatfd  = mvpa.conc$yhatfdobj  
plot(yhatfd)
plot(mvpafd)

mvpa.hat = eval.fd(daytime,yhatfd) 
mvpa.hat.fdata = fdata(t(mvpa.hat), s)

matplot(s, t(func.mean(fdata(mvpa.dat,s))$data),
         type='l', lty=1, col = "#4682B4", ylab = "Daily MVPA (minutes)",xlab = "Days", main = "Daily MVPA")
matlines(s, t(func.mean(mvpa.hat.fdata)$data),
        type='l', lty=1, lwd = 3, col = "gold")
legend("topright", 
       col = c("gold","#4682B4"), 
       lty = 1, lwd = c(3,1), legend = c("Predicted","Original"))
